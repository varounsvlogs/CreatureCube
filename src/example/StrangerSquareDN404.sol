...
/**
 * @title StrangerSquareDN404
 * @notice StrangerSquareDN404 is an open edition NFT minting contract based on DN404, with a fixed mint price and no supply limits.
 * Minting ends when the owner calls `endMint`. Each NFT deed represents 1000 ERC20 tokens in the DN404 system.
 */
contract StrangerSquareDN404 is DN404, Ownable, ERC2981 {
    //string private _name = "Creature Cubes";
    //string private _symbol = "CUBE";
    string private _name = "Stranger Skware";
    string private _symbol = "SKWARE";
    string private _baseURI;
    //uint256 public constant MINT_PRICE = 0.0008 ether;
    uint256 public constant MINT_PRICE = 0.000008 ether;
